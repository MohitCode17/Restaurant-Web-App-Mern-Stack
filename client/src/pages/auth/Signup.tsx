    ...
    <div className="flex items-center justify-center min-h-screen">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-lg border-gray-200 mx-4">
        <div className="mb-4 flex flex-col gap-1">
          <h1 className="font-bold text-2xl">Ready to get a taste of the best?</h1>
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            {fullnameError && <span className="text-sm text-red-500 font-semibold">*Fullname is required</span>}
          </div>
        </div>
        <div className="mb-4">
          <div className="relative">
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            {contactError && <span className="text-sm text-red-500 font-semibold">Contact number is required</span>}
          </div>
        </div>
        <div className="mb-4">
          {loading ? (
